...
<body>
    <div class='section-teste'>
        <div class='container-teste'>
            ...
            if(count($lista_respostas) == 0) {
                echo "<h2>","Esse teste ainda nao foi respondido...","</h2>";
            }
            else {
                foreach($lista_respostas as $resposta_teste) {
                    echo "<center>";
                    echo "------------------------------------------------------", "<br>";
                    echo "ID: ",$resposta_teste->getId(), "<br>";
                    //echo "---", "<br>";
                    $dados_demograficos = $resposta_teste->getDadosDemograficos();
                    echo "Email:  ",$dados_demograficos->getEmail(), "<br>","CEP:  ",$dados_demograficos->getCep(),")", "<br>";
                    //echo "---", "<br>";
                   
                    foreach($resposta_teste->getListaRespostaPergunta() as $resposta_pergunta) {
                        echo "Resposta:  ","(",$resposta_pergunta->getEntradaParticipante()," / ",$resposta_pergunta->getGrauEscolhido(),")", "<br>";
                    }
                ...
                echo "<form action='../../Controllers/Pesquisador/GerarCSV.php' method='post'>";
                    //echo "<input type='submit' value='Gerar relatorio'>";
                    echo "<button type='submit' class='btn btn-success'>Gerar relatório</button>";
                echo "</form>";
            }
        ?>
